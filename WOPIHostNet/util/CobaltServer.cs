            ...
            try
            {
                ...
                try
                {
                    ...
                    if (fileExt.ToLower().Contains("xlsx"))
                        editSession = new FileSession(filename, docInfo.filePath, docInfo.author, docInfo.author, docInfo.mail, false, access_token);
                    else
                        editSession = new CobaltSession(filename, docInfo.filePath, docInfo.author, docInfo.author, docInfo.mail, false, access_token);
